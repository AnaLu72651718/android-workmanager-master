...
class BlurViewModel(application: Application) : ViewModel() {
    ...
    private fun getImageUri(context: Context): Uri {
        ...
        return Uri.Builder()
            ...
            .authority(resources.getResourcePackageName(R.drawable.android_cancun))
            .appendPath(resources.getResourceTypeName(R.drawable.android_cancun))
            .appendPath(resources.getResourceEntryName(R.drawable.android_cancun))
            .build()
    }
